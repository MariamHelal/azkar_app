...
class MorningAzkarPage extends StatefulWidget {
   MorningAzkarPage({Key? key, required this.categoryName, required this.id}) : super(key: key);
...
class _MorningAzkarPageState extends State<MorningAzkarPage> {
  ...
  late TimeOfDay _timeOfDay0=TimeOfDay(hour: 5, minute: 00);
  ...
  Future<void> initializePreferences() async {
    ...
    setState(() {
      ...
      _timeOfDay0= getTimeFromPreferences() ?? TimeOfDay(hour: 5, minute: 00);
  ...
  Future<void> scheduleNotification() async {
    ...
    var selectedTime =DateTime(now.year,now.month,now.day,_timeOfDay0.hour,_timeOfDay0.minute,now.second+1);
